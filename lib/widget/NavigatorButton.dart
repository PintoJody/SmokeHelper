...
class NavigatorButton extends StatefulWidget {
  ...
  const NavigatorButton({required this.parentContext, required this.text, this.bgColor = CustomTheme.greenColor, this.width = 100.0, this.height = 25.0, this.radius = 15.0});
